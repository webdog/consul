...
<EnterpriseAlert>
  This feature is available in v1.7.0+ of: (1) {' '}
  <a href="https://cloud.hashicorp.com/pricing/consul/">HashiCorp Cloud Platform (HCP) Consul - Standard tier and above</a>
  , (2) self-managed {' '}
  <a href="https://www.hashicorp.com/products/consul/">Consul Enterprise</a>,
  and (3) legacy Consul Enterprise with the Governance and Policy module.
</EnterpriseAlert>
