...
import (
	...
	"github.com/hashicorp/consul/command/plugin"
	plugininstall "github.com/hashicorp/consul/command/plugin/install"
...
func init() {
	...
	Register("plugin", func(ui cli.Ui) (cli.Command, error) { return plugin.New(), nil })
	Register("plugin install", func(ui cli.Ui) (cli.Command, error) { return plugininstall.New(ui), nil })
